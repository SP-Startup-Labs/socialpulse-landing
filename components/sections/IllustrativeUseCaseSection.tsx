    ...
    return (
        <section ref={sectionRef} id="roadmap" className="relative overflow-hidden px-5 py-24 md:px-8 md:py-[115px]">
            ...
            <div className="relative mx-auto w-full max-w-[1536px]">
                <p className="mb-5 text-base font-medium text-[#6E9BFF]">Illustrative use case</p>
                ...
                <div className="grid xl:grid-cols-[1.12fr_1fr_0.86fr]">
                    <div className="relative pb-10 xl:min-h-[350px] xl:pr-10">
                        ...
                        <div className="relative">
                            <h2 className="max-w-[520px] text-3xl font-semibold leading-[1.12] tracking-tight text-[#F5F7FA] sm:text-4xl">
                                From emerging voice to credible public figure
                            </h2>

                            <p className="mt-3 text-lg leading-7 text-[#AAB4C2]">Public reaction to an affordable housing proposal</p>

                            <div className="mt-8">
                                <h3 className="text-base font-semibold text-[#F5F7FA]">The conversation</h3>
                                    ...
                                    <div className="relative grid grid-cols-2 gap-x-4 gap-y-6 sm:grid-cols-4">
                                        {conversationTimeline.map((item) => (
                                            <div key={item.date} className="min-w-0 sm:text-center">
                                                ...
                                                <p className="mt-3 text-base font-medium text-[#F5F7FA]">{item.date}</p>
                                                <p className="mt-2 min-h-[48px] text-base leading-6 text-[#AAB4C2]">{item.text}</p>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                    ...
                    <div className="border-t border-white/[0.12] py-10 xl:min-h-[350px] xl:border-l xl:border-t-0 xl:px-10 xl:py-0">
                        <h3 className="text-base font-semibold text-[#F5F7FA]">Emotional shift</h3>
                        ...
                        <div className="mt-7 grid grid-cols-[minmax(0,1fr)_44px_minmax(0,1fr)] gap-x-2">
                            <p className="col-start-1 row-start-1 text-center text-base leading-6 text-[#AAB4C2]">Before clarification</p>
                            <p className="col-start-3 row-start-1 text-center text-base leading-6 text-[#AAB4C2]">After clarification</p>
                            ...
                            <p className="col-start-1 row-start-3 mt-1 text-center text-base text-[#AAB4C2]">Trust</p>
                            <p className="col-start-3 row-start-3 mt-1 text-center text-base text-[#AAB4C2]">Trust</p>
                        </div>
                        ...
                        <div className="mt-10 grid gap-3 sm:grid-cols-2">
                            <div className="flex items-center justify-between gap-3 rounded-lg border border-white/[0.08] bg-white/[0.035] px-4 py-4">
                                <span className="text-base text-[#D5DAE2]">Skepticism</span>
                                <span className="text-base font-semibold text-[#F2398A]">-19%</span>
                            </div>

                            <div className="flex items-center justify-between gap-3 rounded-lg border border-white/[0.08] bg-white/[0.035] px-4 py-4">
                                <span className="text-base text-[#D5DAE2]">Credibility</span>
                    ...
                    <div className="border-t border-white/[0.12] py-10 xl:min-h-[350px] xl:border-l xl:border-t-0 xl:py-0 xl:pl-10">
                        <h3 className="text-base font-semibold text-[#F5F7FA]">Key insight</h3>
                        ...
                        <h3 className="text-base font-semibold text-[#F5F7FA]">Potential outcome</h3>
                        <p className="mt-4 text-base leading-6 text-[#AAB4C2]">Positive narrative momentum</p>
                        <p className="mt-2 text-5xl font-semibold tracking-tight text-[#397BFF]">+41%</p>
                    </div>
                </div>

                <p className="mt-6 text-base leading-6 text-[#6F7B8C]">(*) Illustrative scenario.</p>
            </div>
        </section>
    );
}